[NUM,TXT,RAW]=xlsread('winedata.xls');
Data=NUM(:,1:11)';
Labels=NUM(:,12)';
...
[Error_Rate,Error_Num,Position_Vector,Alpha_Vector,Validation_Vector] = Boost_Validate(Train_Data,Train_Labels,Validation_Data,Validation_Labels,600);
